...
const PYTHON_CONFIG: LanguageConfig = LanguageConfig {
    ...
    keywords: &[
        ...
        "as", "import", "from", "return", "yield", "pass", "break", "continue", "and", "or", "not",
        "in", "is", "lambda", "global", "nonlocal", "del", "assert", "async", "await", "raise",
        "True", "False", "None",
    ],
    comment_patterns: &["#"],
    string_delimiters: &["\"", "'", "'''", "\"\"\""],
...
const RUST_CONFIG: LanguageConfig = LanguageConfig {
    ...
    extensions: &["rs"],
    keywords: &[
        "fn", "struct", "enum", "impl", "trait", "mod", "use", "pub", "const", "static", "let",
        "mut", "if", "else", "match", "for", "while", "loop", "break", "continue", "return",
        "where", "type", "self", "Self", "super", "crate", "extern", "unsafe", "async", "await",
        "move", "ref", "dyn", "abstract", "become", "box", "do", "final", "macro", "override",
